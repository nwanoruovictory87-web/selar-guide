    ...
    <div className="pl-5 pr-5 mt-10 flex flex-col">
      ...
      <div className="flex flex-col  ">
        ...
        <div className="flex flex-col gap-4 mt-4 sm:mt-10">
          <span className="text-gray-800 font-semibold text-[1.1rem] sm:text-[1.3rem]">
            <h5>
              Hey there, i'm Victory - a software developer and Selar affiliate
            </h5>
          </span>
          <span className="text-gray-800 text-[1.1rem] sm:text-[1.2rem] font-medium">
            <h5>
          ...
          <div className="mt-3">
            <span className="text-[1.1rem] text-gray-800 font-semibold sm:text-[1.2rem]">
